...
//Last modified: Tue, Nov 16, 2021 06:24:05 PM
//Codeset: 1252
requires maya "2022";
requires "mtoa" "4.2.1";
requires "mtoa" "4.2.1";
...
fileInfo "UUID" "7A393471-432D-6023-97A4-2BA396ADAF73";
createNode transform -s -n "persp";
	rename -uid "0B5F8D57-4485-1797-FCDE-AFB18EEEAD0B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 384.29920184233299 527.32431707307887 283.78075232273824 ;
	setAttr ".r" -type "double3" -41.138353151558427 4377.7999999993126 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E6F8A516-40A0-694B-2340-E5B3465E24E6";
	setAttr -k off ".v" no;
	setAttr ".fl" 29.025600721469214;
	setAttr ".coi" 537.25648043455737;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.24967601895332336 0.25 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "66C1DCF3-4D09-D23A-1F78-E9BBA06CEDD5";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4B505C7E-491D-DB13-99ED-17AB4F467DCC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "20BB6054-42E7-5B65-29C3-0FA10E6771FB";
createNode displayLayerManager -n "layerManager";
	rename -uid "2265E65B-4DE5-9908-B56A-D6AA3BA56E22";
createNode displayLayer -n "defaultLayer";
	rename -uid "3308FDA8-4A12-4EB8-A975-CABE43263F7E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "113B5FD7-4E09-FC46-A143-F2B9A47867F4";
